...
const Skills = () => {
  return (
    <>
      ...
      lg:h-[80vh] sm:h-[60vh] xs:hover-[50vh]
      ...
      '>
        <motion.div
          className='flex items-center justify-center rounded-full font-semibold bg-dark text-light
            p8 shadow-dark cursor-pointer dark:text-dark dark:bg-light
        ...
        <Skill name='Spring Boot' x='-35vw' y='-10vw' />
        <Skill name='MongoDB' x='5vw' y='23vw' />
        <Skill name='HTML' x='18vw' y='-20vw' />
        <Skill name='CSS' x='28vw' y='13vw' />
