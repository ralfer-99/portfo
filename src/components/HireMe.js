...
const HireMe = () => {
  return (
    ...
    <div className='w-full h-full relative flex items-center justify-center overflow-hidden'>
      <Image className="circular-text w-full h-full z-20 fill-dark animate-spin-slow" src="https://ralfer-99.github.io/circular-text.png"
 alt='some texts'  width={800} height={800} />
